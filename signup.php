			    ...
			    <div class="app-auth-body mx-auto">	
					...
					if ($_SERVER["REQUEST_METHOD"] == "POST") {
					    ...
					    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
					        ...
					        // Update the table and column names to match your new database schema
					        $stmt = $conn->prepare("INSERT INTO customer (email, password_hash) VALUES (:email, :password_hash)");
					        $stmt->bindParam(':email', $email);
					        $stmt->bindParam(':password_hash', $hash);

					        if ($stmt->execute()) {
					            echo '<div class="alert alert-success" role="alert">You are now registered!</div>';
					        } else {
					            echo '<div class="alert alert-danger" role="alert">Error: ' . $stmt->errorInfo()[2] . '</div>';
					        }
					    }
					}
